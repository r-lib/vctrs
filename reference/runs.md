...
- `vec_run_sizes()` returns an integer vector corresponding to the size
  ...
  faster if you don't need the run keys.

- [`vec_unrep()`](https://vctrs.r-lib.org/reference/vec-rep.md) is a
  ...
  [`vec_rep_each()`](https://vctrs.r-lib.org/reference/vec-rep.md); look
...
[`vec_unrep()`](https://vctrs.r-lib.org/reference/vec-rep.md) for a
