...
- action:
  ...
  [`vec_ptype2()`](https://vctrs.r-lib.org/reference/vec_ptype2.md) use
  `"combine"` and those thrown from
  [`vec_cast()`](https://vctrs.r-lib.org/reference/vec_cast.md) use
  `"convert"`.
...
- x_ptype, to_ptype:
  ...
  [prototypes](https://vctrs.r-lib.org/reference/vec_ptype.md).
