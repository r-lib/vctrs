...
FAQ](https://vctrs.r-lib.org/reference/faq-error-scalar-type.md) about
this topic). Sometimes vctrs won’t treat your class as a vector when it
should.
...
that returns its input if explicit inheritance is not possible or
troublesome:
