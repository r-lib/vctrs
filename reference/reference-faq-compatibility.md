...
using [`new_vctr()`](https://vctrs.r-lib.org/reference/new_vctr.md) as
documented in
...
- [`vec_slice()`](https://vctrs.r-lib.org/reference/vec_slice.md) falls
  back to the base `[` generic if no
  [`vec_proxy()`](https://vctrs.r-lib.org/reference/vec_proxy.md) method
  is implemented. This way foreign classes that do not implement
  [`vec_restore()`](https://vctrs.r-lib.org/reference/vec_proxy.md) can
...
[`vec_count()`](https://vctrs.r-lib.org/reference/vec_count.md) for an
example.
...
See the [theory
overview](https://vctrs.r-lib.org/reference/theory-faq-coercion.md).
...
the [howto
guide](https://vctrs.r-lib.org/reference/howto-faq-coercion.md) if you
need to implement methods for these generics.
...
[`vec_proxy()`](https://vctrs.r-lib.org/reference/vec_proxy.md) defaults
to an [identity](https://rdrr.io/r/base/identity.html) function and you
...
[`vec_proxy()`](https://vctrs.r-lib.org/reference/vec_proxy.md) or make
your class inherit from list.
