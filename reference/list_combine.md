...
[`vec_c()`](https://vctrs.r-lib.org/reference/vec_c.md). While
[`vec_c()`](https://vctrs.r-lib.org/reference/vec_c.md) is used for
...
- slice_x:
  ...
  [`vec_assign()`](https://vctrs.r-lib.org/reference/vec_slice.md) for
  more examples.
