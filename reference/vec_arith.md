...
[vctr](https://vctrs.r-lib.org/reference/new_vctr.md)s objects,
...
See [`vec_math()`](https://vctrs.r-lib.org/reference/vec_math.md) for
the equivalent for the unary mathematical functions.
