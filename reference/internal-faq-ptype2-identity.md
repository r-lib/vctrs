...
[`vec_ptype2()`](https://vctrs.r-lib.org/reference/vec_ptype2.md) is a
[monoid](https://en.wikipedia.org/wiki/Monoid) over vectors, which in
...
[`vec_ptype2()`](https://vctrs.r-lib.org/reference/vec_ptype2.md) needs
an identity element, i.e. a value that doesn’t change the result of the
reduction. vctrs has two identity values, `NULL` and **unspecified**
vectors.
