...
[type](https://vctrs.r-lib.org/reference/vec_ptype.md).
...
[`vec_slice()`](https://vctrs.r-lib.org/reference/vec_slice.md) for a
variation of `[` compatible with `vec_size()`, and
[`vec_recycle()`](https://vctrs.r-lib.org/reference/vec_recycle.md) to
[recycle](https://vctrs.r-lib.org/reference/theory-faq-recycling.md)
