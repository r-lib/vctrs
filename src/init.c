...
extern SEXP vctrs_duplicate_split_old(SEXP);
extern SEXP vctrs_duplicate_split_new(SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"vctrs_duplicate_split_old",  (DL_FUNC) &vctrs_duplicate_split_old,  1},
    {"vctrs_duplicate_split_new",  (DL_FUNC) &vctrs_duplicate_split_new,  1},
