...
// [[ register() ]]
SEXP vctrs_new_altrep_vctrs_compact_rep_dbl(SEXP value, SEXP size) {
  Rf_errorcall(R_NilValue, "Need R 3.5+ for ALTREP support");
  return R_NilValue;
}
...
SEXP altrep_vctrs_compact_rep_dbl_class_sexp = NULL;
...
static void vctrs_init_altrep_vctrs_compact_rep_int(DllInfo* dll) {
...
SEXP new_altrep_vctrs_compact_rep_dbl(double value, R_xlen_t size) {
  ...
  SEXP out = R_new_altrep(altrep_vctrs_compact_rep_dbl_class, info, R_NilValue);
...
SEXP vctrs_new_altrep_vctrs_compact_rep_dbl(SEXP value, SEXP size) {
  ...
  return new_altrep_vctrs_compact_rep_dbl(value_, size_);
}

static void vctrs_init_altrep_vctrs_compact_rep_dbl(DllInfo* dll) {
  altrep_vctrs_compact_rep_dbl_class = R_make_altreal_class("vctrs_compact_rep_dbl", "vctrs", dll);

  altrep_vctrs_compact_rep_dbl_class_sexp = R_SEXP(altrep_vctrs_compact_rep_dbl_class);
  R_PreserveObject(altrep_vctrs_compact_rep_dbl_class_sexp);

  // ALTREP methods
  R_set_altrep_Serialized_state_method(altrep_vctrs_compact_rep_dbl_class, vctrs_compact_rep_dbl_Serialized_state);
  R_set_altrep_Unserialize_method(altrep_vctrs_compact_rep_dbl_class, vctrs_compact_rep_dbl_Unserialize);
  R_set_altrep_Duplicate_method(altrep_vctrs_compact_rep_dbl_class, vctrs_compact_rep_dbl_Duplicate);
  R_set_altrep_Coerce_method(altrep_vctrs_compact_rep_dbl_class, vctrs_compact_rep_dbl_Coerce);
  R_set_altrep_Inspect_method(altrep_vctrs_compact_rep_dbl_class, vctrs_compact_rep_dbl_Inspect);
  R_set_altrep_Length_method(altrep_vctrs_compact_rep_dbl_class, vctrs_compact_rep_dbl_Length);

  // ALTVEC methods
  R_set_altvec_Dataptr_method(altrep_vctrs_compact_rep_dbl_class, vctrs_compact_rep_dbl_Dataptr);
  R_set_altvec_Dataptr_or_null_method(altrep_vctrs_compact_rep_dbl_class, vctrs_compact_rep_dbl_Dataptr_or_null);
  R_set_altvec_Extract_subset_method(altrep_vctrs_compact_rep_dbl_class, vctrs_compact_rep_dbl_Extract_subset);
