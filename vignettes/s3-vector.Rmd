...
-   Use `testthat::verify_output()` to test your format method.
    ...
    Read more about `verify_output()` in the [testthat v2.3.0 blog post](https://tidyverse.org/blog/2019/11/testthat-2-3-0/); it's an example of a so-called [golden test](https://ro-che.info/articles/2017-12-04-golden-tests).
