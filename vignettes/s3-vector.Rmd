...
* As an S3 method, it implements `vctrs::vec_ptype2()` for the `vctrs_percent` class.

* As a generic, `vec_ptype2.vctrs_percent()` has `default`, `vctrs_percent`, and `double` methods (see below).
