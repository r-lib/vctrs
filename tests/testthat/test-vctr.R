...
test_that("base coercions default to vec_cast", {
  ...
  expect_error(as.factor(h), class = "error_incompatible_cast")
  expect_error(as.ordered(h), class = "error_incompatible_cast")
  expect_error(as.difftime(h), class = "error_incompatible_cast")
