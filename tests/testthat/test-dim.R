...
test_that("n_dim is number of dimensions", {
  expect_equal(vec_n_dim(array(dim = c(1))), 1)
  expect_equal(vec_n_dim(array(dim = c(1, 1))), 2)
  expect_equal(vec_n_dim(array(dim = c(1, 1, 1))), 3)
})
