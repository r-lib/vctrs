...
test_that("lossy casts generate warning", {
  ...
  expect_condition(vec_cast(datetime, date), class = "vctrs_warning_cast_lossy")
})
...
test_that("date-time vs difftime", {
  ...
  expect_warning(expect_equal(vec_arith("+", d, th), d + th), class = "vctrs_warning_cast_lossy")
  expect_equal(vec_arith("-", dt, t), dt - t)
  expect_equal(vec_arith("-", d, t), d - t)
  expect_equal(vec_arith("-", dt, th), dt - th)
  expect_warning(expect_equal(vec_arith("-", d, th), d - th), class = "vctrs_warning_cast_lossy")
  ...
  expect_warning(expect_equal(vec_arith("+", th, d), d + th), class = "vctrs_warning_cast_lossy")
