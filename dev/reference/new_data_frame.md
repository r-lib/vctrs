...
[`df_list()`](https://vctrs.r-lib.org/dev/reference/df_list.md), which
...
[`df_list()`](https://vctrs.r-lib.org/dev/reference/df_list.md) for a
way to safely construct a data frame's underlying data structure from
