...
- A vector has vectorised attributes, i.e. metadata for each element of
  ...
  [`rcrd`](https://vctrs.r-lib.org/dev/reference/new_rcrd.md) class. It
...
[`vec_slice()`](https://vctrs.r-lib.org/dev/reference/vec_slice.md) are
...
types](https://vctrs.r-lib.org/dev/reference/new_rcrd.md). Record types
...
[`vec_slice()`](https://vctrs.r-lib.org/dev/reference/vec_slice.md) has
been called), and all other attributes may have been lost. The method
should restore all attributes so that after restoration,
...
- `x` must be a vector in the vctrs sense (see
  [`vec_is()`](https://vctrs.r-lib.org/dev/reference/vec_assert.md))
