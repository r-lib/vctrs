...
methods for coercions of data frame subclasses. Related topics:
...
(which are in turn used by a number of dplyr and tidyr functions). These
...
[`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md)
this means you need to call
[`df_ptype2()`](https://vctrs.r-lib.org/dev/reference/df_ptype2.md) (for
data frame subclasses) or
[`tib_ptype2()`](https://vctrs.r-lib.org/dev/reference/df_ptype2.md)
(for tibble subclasses). Similarly,
[`df_cast()`](https://vctrs.r-lib.org/dev/reference/df_ptype2.md) and
[`tib_cast()`](https://vctrs.r-lib.org/dev/reference/df_ptype2.md) are
the workhorses for
[`vec_cast()`](https://vctrs.r-lib.org/dev/reference/vec_cast.md)
methods of subtypes of `data.frame` and `tbl_df`. These functions take
the union of the columns in `x` and `y`, and ensure shared columns have
the same type.

These functions are much less strict than
[`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md)
and [`vec_cast()`](https://vctrs.r-lib.org/dev/reference/vec_cast.md) as
they accept any subclass of data frame as input. They always return a
...
[`df_ptype2()`](https://vctrs.r-lib.org/dev/reference/df_ptype2.md) and
[`df_cast()`](https://vctrs.r-lib.org/dev/reference/df_ptype2.md), and
...
The [`vec_cast()`](https://vctrs.r-lib.org/dev/reference/vec_cast.md)
methods follow the same pattern, but note how the method for coercing to
data frame uses
[`df_cast()`](https://vctrs.r-lib.org/dev/reference/df_ptype2.md) rather
than `dt_cast()`.
...
- They call their parent methods, in this case
  [`tib_ptype2()`](https://vctrs.r-lib.org/dev/reference/df_ptype2.md)
  and [`tib_cast()`](https://vctrs.r-lib.org/dev/reference/df_ptype2.md)
...
Note the call to
[`vctrs::tib_cast()`](https://vctrs.r-lib.org/dev/reference/df_ptype2.md):
