...
[`vec_c()`](https://vctrs.r-lib.org/dev/reference/vec_c.md), but does so
in such a way that the elements of each vector are interleaved together.
...
- .ptype:
  ...
  Each vector will be
  [cast](https://vctrs.r-lib.org/dev/reference/theory-faq-coercion.md)
  to this type.
