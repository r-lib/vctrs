...
[`vec_match()`](https://vctrs.r-lib.org/dev/reference/vec_match.md) used
to identify locations where each value of `needles` matches one or
multiple values in `haystack`. Unlike
...
[`vec_match()`](https://vctrs.r-lib.org/dev/reference/vec_match.md) is
