...
## Difference with [`vec_proxy()`](https://vctrs.r-lib.org/dev/reference/vec_proxy.md)
...
- [`vec_proxy()`](https://vctrs.r-lib.org/dev/reference/vec_proxy.md)
  may return structured data. This generic is the main customisation
  point for accessing memory values in vctrs, along with
