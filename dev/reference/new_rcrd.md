...
[vctr](https://vctrs.r-lib.org/dev/reference/new_vctr.md). A rcrd is
composed of 1 or more
[field](https://vctrs.r-lib.org/dev/reference/fields.md)s, which must be
...
- fields:
  ...
  with [`df_list()`](https://vctrs.r-lib.org/dev/reference/df_list.md)
  to ensure uniquely named vectors.
