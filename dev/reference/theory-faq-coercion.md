...
and their role in the vctrs coercion mechanism. Related topics:
...
[`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md)
and [`vec_cast()`](https://vctrs.r-lib.org/dev/reference/vec_cast.md).
They both take two arguments and perform **double dispatch**, meaning
that a method is selected based on the classes of both inputs.
...
[`vec_proxy()`](https://vctrs.r-lib.org/dev/reference/vec_proxy.md) and
...
Methods for
[`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md)
are passed two *prototypes*, i.e. two inputs emptied of their elements.
They implement two behaviours:
...
the one that looks at the data and actually performs the conversion.
Because it has access to more information than
[`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md),
it may be stricter and cause an error in more cases.
[`vec_cast()`](https://vctrs.r-lib.org/dev/reference/vec_cast.md) has
...
- Return the input vector converted to the target type if all values are
  compatible. Whereas
  [`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md)
  must return the same type when the inputs are permuted,
  [`vec_cast()`](https://vctrs.r-lib.org/dev/reference/vec_cast.md) is
...
[`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md)
and [`vec_cast()`](https://vctrs.r-lib.org/dev/reference/vec_cast.md)
looks like S3 but is actually a custom mechanism. Compared to S3, it has
...
2.  Find the common type for each column by calling
    [`vec_ptype2()`](https://vctrs.r-lib.org/dev/reference/vec_ptype2.md)
    on each pair of matched columns.
...
[`vec_cast()`](https://vctrs.r-lib.org/dev/reference/vec_cast.md)
operates similarly. If a data frame is cast to a target type that has
fewer columns, this is an error.
...
as [`df_ptype2()`](https://vctrs.r-lib.org/dev/reference/df_ptype2.md)
and [`df_cast()`](https://vctrs.r-lib.org/dev/reference/df_ptype2.md).
