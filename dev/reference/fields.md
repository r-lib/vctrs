...
A [rcrd](https://vctrs.r-lib.org/dev/reference/new_rcrd.md) behaves like
a vector, so [`length()`](https://rdrr.io/r/base/length.html),
...
- x:
  ...
  A [rcrd](https://vctrs.r-lib.org/dev/reference/new_rcrd.md), i.e. a
  list of equal length vectors with unique names.
