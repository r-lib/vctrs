...
The second problem is `dplyr::bind_rows()`: how should it handle vectors implemented in other packages? It currently handles them using a set of heuristics which have lead to many issues over the last few years.
