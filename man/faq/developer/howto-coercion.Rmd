...
s3_register("base::print", "my_natural")
s3_register("base::[", "my_natural")
```
...
```{r, include = FALSE}
# Necessary because includeRmd() evaluated in a child of global
s3_register("vctrs::vec_ptype2", "my_natural.my_natural")
```
...
```{r, include = FALSE}
# Necessary because includeRmd() evaluated in a child of global
s3_register("vctrs::vec_ptype2", "my_natural.logical")
s3_register("vctrs::vec_ptype2", "my_natural.integer")
s3_register("vctrs::vec_ptype2", "integer.my_natural")
s3_register("vctrs::vec_ptype2", "logical.my_natural")
```
...
```{r, include = FALSE}
# Necessary because includeRmd() evaluated in a child of global
s3_register("vctrs::vec_ptype2", "my_natural.double")
s3_register("vctrs::vec_ptype2", "double.my_natural")
```
...
```{r, include = FALSE}
# Necessary because includeRmd() evaluated in a child of global
s3_register("vctrs::vec_cast", "my_natural.my_natural")
s3_register("vctrs::vec_cast", "my_natural.logical")
s3_register("vctrs::vec_cast", "my_natural.integer")
s3_register("vctrs::vec_cast", "my_natural.double")
```
...
```{r, include = FALSE}
# Necessary because includeRmd() evaluated in a child of global
s3_register("vctrs::vec_cast", "logical.my_natural")
s3_register("vctrs::vec_cast", "integer.my_natural")
s3_register("vctrs::vec_cast", "double.my_natural")
```
