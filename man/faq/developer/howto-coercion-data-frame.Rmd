...
s3_register("base::print", "my_tibble")
```
...
```{r, include = FALSE}
# Necessary because includeRmd() evaluated in a child of global
s3_register("vctrs::vec_ptype2", "my_tibble.my_tibble")
s3_register("vctrs::vec_cast", "my_tibble.my_tibble")

s3_register("vctrs::vec_ptype2", "my_tibble.tbl_df")
s3_register("vctrs::vec_ptype2", "tbl_df.my_tibble")

s3_register("vctrs::vec_cast", "tbl_df.my_tibble")
s3_register("vctrs::vec_cast", "my_tibble.tbl_df")
```
...
```{r, include = FALSE}
# Necessary because includeRmd() evaluated in a child of global
s3_register("vctrs::vec_ptype2", "my_tibble.data.frame")
s3_register("vctrs::vec_ptype2", "data.frame.my_tibble")

s3_register("vctrs::vec_cast", "my_tibble.data.frame")
s3_register("vctrs::vec_cast", "data.frame.my_tibble")
```
